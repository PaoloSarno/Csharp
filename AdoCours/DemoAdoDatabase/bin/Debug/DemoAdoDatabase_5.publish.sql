...
CREATE VIEW [dbo].[V_User]
	...
	WHERE [IsActive] = 1
GO
PRINT N'Création de Procédure [dbo].[SP_Todo_AddTodo]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '039916a0-01e6-4986-8f4c-928f16958d7a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('039916a0-01e6-4986-8f4c-928f16958d7a')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'efe5b2d4-4737-4322-bf9c-bef22945ca5b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('efe5b2d4-4737-4322-bf9c-bef22945ca5b')
